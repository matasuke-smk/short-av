...
export default function VideoSwiper({ videos }: VideoSwiperProps) {
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-black overflow-hidden">
            ...
            {videos.map((video) => (
              ...
              >
                ...
                <div className="flex flex-col items-center bg-orange-500">
                  {/* タイトル */}
                  <h2 className="text-white text-sm font-bold text-center line-clamp-2 w-full px-4 h-10 flex items-center justify-center bg-blue-500">
                    {video.title}
                  </h2>
      ...
      {/* 下部固定エリア */}
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-purple-500 px-6 pt-4 pb-[max(env(safe-area-inset-bottom),0.5rem)] h-[calc(100dvh-1.5rem-75vw-31.25vw-2.5rem)]">
