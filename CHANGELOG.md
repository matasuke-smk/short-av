...
- 左側55%: 動画表示エリア
- 右側45%: ボタン・情報エリア
- 動画モーダル: 左5%操作エリア、中央95%動画エリア（バナー非表示で最大化）
- 動画プレイヤーのサイズを最大化: `h-screen`と`h-full`で画面いっぱいに表示
...
- `14b6f76` - 動画プレイヤーを画面いっぱいに表示（h-fullとh-screen使用）
- `800fb0e` - バナーを非表示にして動画エリアを最大化（左5%、中央95%）
